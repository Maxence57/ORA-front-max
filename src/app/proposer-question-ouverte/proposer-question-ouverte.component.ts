...
@Component({
  selector: 'app-proposer-question-ouverte',
  templateUrl: './proposer-question-ouverte.component.html',
  styleUrls: ['./proposer-question-ouverte.component.css']
})
export class ProposerQuestionOuverteComponent implements OnInit {
  answer: string;
