...
@Component({
  selector: 'app-proposer-oui-non',
  templateUrl: './proposer-oui-non.component.html',
  styleUrls: ['./proposer-oui-non.component.css']
})
export class ProposerOuiNonComponent implements OnInit {
